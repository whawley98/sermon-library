...
if exist "%S%\KJVPanel.js"              copy /Y "%S%\KJVPanel.js"              "%R%\src\components\KJVPanel.js"           && echo [OK] KJVPanel.js
if exist "%S%\KJVPanel.css"             copy /Y "%S%\KJVPanel.css"             "%R%\src\components\KJVPanel.css"          && echo [OK] KJVPanel.css
if exist "%S%\SermonTextRenderer.js"    copy /Y "%S%\SermonTextRenderer.js"    "%R%\src\components\SermonTextRenderer.js" && echo [OK] SermonTextRenderer.js
if exist "%S%\SermonTextRenderer.css"   copy /Y "%S%\SermonTextRenderer.css"   "%R%\src\components\SermonTextRenderer.css" && echo [OK] SermonTextRenderer.css
...
if exist "%S%\upload_sermons.py"        copy /Y "%S%\upload_sermons.py"        "%R%\scripts\upload_sermons.py"            && echo [OK] upload_sermons.py
if exist "%S%\enrich_sermons.py"        copy /Y "%S%\enrich_sermons.py"        "%R%\scripts\enrich_sermons.py"            && echo [OK] enrich_sermons.py
if exist "%S%\shared.py"                copy /Y "%S%\shared.py"                "%R%\scripts\shared.py"                    && echo [OK] shared.py
if exist "%S%\reindex_algolia.py"       copy /Y "%S%\reindex_algolia.py"       "%R%\scripts\reindex_algolia.py"           && echo [OK] reindex_algolia.py
if exist "%S%\load_kjv.py"              copy /Y "%S%\load_kjv.py"              "%R%\scripts\load_kjv.py"                  && echo [OK] load_kjv.py
...
if exist "%S%\firebase.json"            copy /Y "%S%\firebase.json"            "%R%\firebase.json"                        && echo [OK] firebase.json
if exist "%S%\firestore.indexes.json"   copy /Y "%S%\firestore.indexes.json"   "%R%\firestore.indexes.json"               && echo [OK] firestore.indexes.json
